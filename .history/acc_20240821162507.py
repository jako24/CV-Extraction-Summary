...
def calculate_extraction_accuracy(file_path):
    ...
    summary_row = {
        'LoaderAccuracy': mean_loader_accuracy,
        'OCRAccuracy': mean_ocr_accuracy,
        'CombinedOCRAccuracy': mean_combined_ocr_accuracy,
        'EasyOCRAccuracy': mean_easyocr_accuracy
    }
    ...
    df = df._append(summary_row, ignore_index=True)
