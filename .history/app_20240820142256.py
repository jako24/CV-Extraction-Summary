...
def merge_information(ocr_info, pypdf_info):
    ...
    if 'contact_info' in pypdf_info:
        ...
        merged['contact_info']['name'] = pypdf_info['contact_info'].get('name') or merged['contact_info'].get('name', '')
...
def process_resume(uploaded_file):
    try:
        ...
        try:
            ...
            text_pypdf, information_pypdf, summary_pypdf = pypdf_loader_merge(temp_file_path)
            if not text_pypdf:
