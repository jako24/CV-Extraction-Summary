...
def compare_contact_info(extracted_value, correct_value):
    ...
    # Average the accuracy of email and phone
...
def calculate_extraction_accuracy(file_path):
    ...
    # Modify your apply lambda to handle lowercasing safely
...
# Usage example
csv_path = '/Users/janekkorczynski/CVExtraction/AccuracyCheck - final_accuracy.csv'
