...
def process_resume(uploaded_file):
    try:
        ...
        # Merge specific information
        logger.info("Merging specific information...")
        try:
            ...
            # Merge skills
            if 'skills' in information_pypdf:
                merged_information['skills'] = merged_information.get('skills', {})
                merged_information['skills']['technical_skills'] = list(set(
                    merged_information['skills'].get('technical_skills', []) + 
                    information_pypdf['skills'].get('technical_skills', [])
                ))
                merged_information['skills']['soft_skills'] = list(set(
                    merged_information['skills'].get('soft_skills', []) + 
                    information_pypdf['skills'].get('soft_skills', [])
                ))
