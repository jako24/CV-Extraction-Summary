...
def calculate_extraction_accuracy(file_path):
    ...
    required_columns = {'CombinedOCRPDFExtraction', 'EasyOCRExtraction', 'CorrectExtraction'}
    if not required_columns.issubset(df.columns):
        raise ValueError("The file does not contain the required columns.")
    
    # Calculate accuracies for each row using the combined and easy OCR extractions
    ...
    # Add two new columns for accuracy calculations (without modifying any other columns)
