...
def merge_information(ocr_info, pypdf_info):
    def merge_skills(ocr_skills, pypdf_skills):
        # Ensure both skills exist as lists, then merge them
    ...
    # Merge education, only if PyPDFLoader provides more info or OCR is empty
    ...
    # Merge work experience, similarly only if OCR lacks it
...
def process_resume(uploaded_file):
    try:
        ...
        try:
            ...
            text_pypdf, information_pypdf, summary_pypdf = pypdf_loader(temp_file_path)
            if not text_pypdf:
        ...
        # Step 3: Merge information from OCR and PyPDFLoader
        ...
        try:
            ...
            # Log merged information for debugging
